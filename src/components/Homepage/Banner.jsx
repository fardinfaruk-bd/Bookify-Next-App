        ...
        <div className=" bg-base-200 min-h-[80vh] container mx-auto">
            <div className="flex justify-between w-full p-30 items-center gap-30">
                <div className='space-y-8'>
                    <h1 className="text-6xl font-bold">Find Your <br /> Next <span className='bg-linear-to-r from-[#21217167] to-[#3DAAB0] bg-clip-text text-transparent text-7xl'>Read!!!</span></h1>        
