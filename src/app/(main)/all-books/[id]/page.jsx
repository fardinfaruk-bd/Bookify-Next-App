        ...
        <div className='grid grid-cols-12 container mx-auto mt-20 gap-10 mb-30'>
            ...
            <div className="space-y-10 p-2 col-span-12 md:col-span-7">
                ...
                <div className='grid grid-cols-3 gap-5'>
                    <div className='bg-white rounded-lg py-5 shadow-lg flex flex-col items-center '>
                    ...
                    <div className='bg-white rounded-lg py-5 shadow-lg flex flex-col items-center text-center '>
